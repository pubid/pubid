...
original = PubidNew::Iso.parse("ISO 9001:2015/Amd 1:2020/Cor 1:2021")
hash = original.to_h
...
id3 = PubidNew::Iso.parse("ISO 9002:2019")
...
base = PubidNew::Iso.parse("ISO 9001:2015")
...
**New in Session 289:** AerospaceStandard identifier type handling 27 aerospace/specialized prefixes (A, AU, B, C, F, G, HC, L, M, MA, PL, SP, TA, X, 2A-2X, 3A-3TA, 4F-4S, 5S, 7S) with proper TYPED_STAGES integration.
