...
**Sessions 199, 249: NIST 99.98%** ✨ - FIPS month-year + revision year preservation
...
**Session 250: PLATEAU Annex** ✨ - Annex supplement with proper MECE architecture
...
|100%
|✅ Perfect
|3 types (Handbook, TechnicalReport, Annex), Session 250
...
NIST parser handles all series withFIPS month-year patterns (Sessions 199, 249):
...
.Joint Published Standards

CIE collaborates with ISO and IEC on joint publications:

[source,ruby]
----
# Joint with ISO
joint_iso = PubidNew::Cie.parse("CIE ISO 11664-1:2019")
joint_iso.copublisher  # => "ISO"
joint_iso.to_s         # => "CIE ISO 11664-1:2019"

# Joint Technical Report
joint_tr = PubidNew::Cie.parse("CIE ISO TR 21783:2022(E)")
joint_tr.type          # => "TR"
joint_tr.to_s          # => "CIE ISO TR 21783:2022(E)"

# Joint with IEC
joint_iec = PubidNew::Cie.parse("CIE IEC 017.4-1987")
joint_iec.copublisher  # => "IEC"
----

.Conference Publications

Conference proceedings use x-prefix notation:

[source,ruby]
----
# Basic conference
conf = PubidNew::Cie.parse("CIE x038:2013")
conf.conference_number  # => "038"
conf.to_s               # => "CIE x038:2013"

# Conference with amendment
conf_amd = PubidNew::Cie.parse("CIE x038:2013 Amendment 1")
conf_amd.amendment_number  # => "1"
conf_amd.to_s              # => "CIE x038:2013 Amendment 1"
----

.Supplements and Corrigenda

CIE supports supplements (SP) and corrigenda (Cor) with recursive base identifier parsing:

[source,ruby]
----
# Supplement with part notation
suppl = PubidNew::Cie.parse("CIE 198-SP1.4:2011")
suppl.supplement_number  # => "1"
suppl.supplement_part    # => "4"
suppl.base_identifier.to_s  # => "CIE 198"

# Corrigendum
cor = PubidNew::Cie.parse("CIE 232:2019/Cor1:2020")
cor.corrigendum_number   # => "1"
cor.year                 # => "2020"
cor.base_identifier.to_s # => "CIE 232:2019"
----
