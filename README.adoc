...
PubID V2 implements a completely redesigned parser architecture with clean separation of concerns and model-driven design. The V2 implementation is located in [`lib/pubid/`](lib/pubid/) while V1 code remains in [`gems/`](gems/) for backward compatibility.
