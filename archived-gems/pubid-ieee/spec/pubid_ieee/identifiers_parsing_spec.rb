    ...
    RSpec.describe Identifier do
      ...
      describe "parse specific identifiers" do
        ...
        context "IEEE Unapproved Draft Std P11073-20601_D20 May 2008" do
          let(:original) do
            "IEEE Unapproved Draft Std P11073-20601_D20 May 2008"
          end
        ...
        context "IEEE Unapproved Draft Std P1616a/D4, Jan 2010" do
          ...
          let(:full_pubid) do
            "IEEE Unapproved Draft Std P1616a/D4, January 2010"
          end
        ...
        context "IEEE Unapproved Draft Std PC37.101/D13, Jun 2006" do
          ...
          let(:full_pubid) do
            "IEEE Unapproved Draft Std PC37.101/D13, June 2006"
          end
        ...
        context "IEEE Std 1666 IEC61691-7 Edition 1.0 2009-12" do
          ...
          let(:pubid) do
            "IEEE Std 1666 (IEC 61691-7 Edition 1.0, December 2009)"
          end
        ...
        context "IEEE Std C37.111-2013 (IEC 60255-24 Edition 2.0 2013-04)" do
          ...
          let(:pubid) do
            "IEEE Std C37.111-2013 (IEC 60255-24 ED2.0, April 2013)"
          end
        ...
        context "ISO/IEEE mixed format identifiers" do
          ...
          context "IEEE/ISO/IEC P29119-3-DIS2, September 2012" do
            ...
            let(:pubid) do
              "IEEE/IEC/ISO Draft Std P29119-3/DIS2, September 2012"
            end
