...
The V2 implementation is located in [`lib/pubid/nist/`](../../lib/pubid/nist/) while V1 code remains for backward compatibility during the migration period.
...
Parser:: [`parser.rb`](../../lib/pubid/nist/parser.rb) - Parslet-based grammar defining syntax rules (~300 lines)
Builder:: [`builder.rb`](../../lib/pubid/nist/builder.rb) - Transforms parse tree to attributes (~200 lines)
Identifier:: [`identifiers/`](../../lib/pubid/nist/identifiers/) - Lutaml::Model classes with rendering logic

==== Identifier classes

The V2 implementation uses dedicated identifier classes for different publication types:

Base:: [`identifiers/base.rb`](../../lib/pubid/nist/identifiers/base.rb) - Standard NIST publications
Circular:: [`identifiers/circular.rb`](../../lib/pubid/nist/identifiers/circular.rb) - NBS CIRC and LCIRC series
CommercialStandardsMonthly:: [`identifiers/commercial_standards_monthly.rb`](../../lib/pubid/nist/identifiers/commercial_standards_monthly.rb) - NBS CSM series
...
id = Pubid::Nist.parse("NBS LCIRC 1035r1985")
id.to_s  # => "NBS LCIRC 1035r1985"
----
====

**Implementation:** Added "NBS LCIRC" to compound_series in [`parser.rb:24`](../../lib/pubid/nist/parser.rb#L24)
...
# Volume 7, Number 12
id = Pubid::Nist.parse("NBS CSM v7n12")
id.to_s  # => "NBS CSM v7n12"

# Volume 9, Number 9
id = Pubid::Nist.parse("NBS CSM v9n9")
id.to_s  # => "NBS CSM v9n9"
----
====

**Implementation:** Added v#n# pattern to first_number in [`parser.rb:67`](../../lib/pubid/nist/parser.rb#L67)
...
**Implementation:**
- Added "supprev" pattern in [`parser.rb:70`](../../lib/pubid/nist/parser.rb#L70)
- Special handling in [`builder.rb:145`](../../lib/pubid/nist/builder.rb#L145)
- Rendering logic in [`identifiers/base.rb:280`](../../lib/pubid/nist/identifiers/base.rb#L280)
...
**Implementation:**
- Pattern for number+edition+revision+date in [`parser.rb`](../../lib/pubid/nist/parser.rb)
- Extraction logic in [`builder.rb`](../../lib/pubid/nist/builder.rb)
- Rendering with "rev" not "-" in [`identifiers/base.rb`](../../lib/pubid/nist/identifiers/base.rb)
...
----
# 2-digit year input
id = Pubid::Nist.parse("NBS HB e104-43")
id.to_s  # => "NBS HB e104-1943"  # Expanded to 4 digits
----
====

**Implementation:** Year expansion logic in [`identifiers/base.rb:266`](../../lib/pubid/nist/identifiers/base.rb#L266)
...
----
cd gems/pubid-nist
bundle exec rspec spec/pubid/nist/ --format documentation
----
...
File.readlines('spec/fixtures/allrecords.txt').each do |line|
  ...
  next if id.empty?
  total += 1
  passes += 1 if Pubid::Nist.parse(id).to_s == id rescue nil
end
