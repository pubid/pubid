...
RSpec.describe "CEN Serialization" do
  describe "#to_h" do
    it "exports basic identifier as hash" do
      id = Pubid::CenCenelec.parse("EN 228:2008")
      hash = id.to_h

      expect(hash[:flavor]).to eq("cen_cenelec")
    ...
    it "exports identifier with part" do
      id = Pubid::CenCenelec.parse("EN 12464-1:2011")
      hash = id.to_h
    ...
    it "exports identifier with draft stage" do
      id = Pubid::CenCenelec.parse("prEN 12464-1:2019")
      hash = id.to_h
  ...
  describe "#to_json" do
    it "exports identifier as JSON" do
      ...
      expect(parsed["flavor"]).to eq("cen_cenelec")
  ...
  describe ".from_json" do
    it "creates identifier from JSON" do
      json = '{"flavor":"cen_cenelec","publisher":"EN","number":"228","year":"2008"}'
  ...
  describe "round-trip conversion" do
    it "preserves all data through hash conversion" do
      original = Pubid::CenCenelec.parse("EN 228:2008")
      hash = original.to_h
