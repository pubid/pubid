...
RSpec.describe "ASHRAE Serialization" do
  describe "#to_h" do
    it "exports basic identifier as hash" do
      id = Pubid::Ashrae.parse("ASHRAE Standard 90.1-2022")
      hash = id.to_h
  ...
  describe "round-trip conversion" do
    it "preserves all data through hash conversion" do
      original = Pubid::Ashrae.parse("ASHRAE Standard 90.1-2022")
      hash = original.to_h
    ...
    it "preserves all data through JSON conversion" do
      original = Pubid::Ashrae.parse("ASHRAE Guideline 28-2016")
