...
RSpec.describe Pubid::Iso::Identifiers::Pas do
  ...
  context "parse normal dated pas" do
    ...
    describe "ISO/PAS 5643:2021" do
      ...
      it "parses number" do
        expect(parsed.number).to eq("5643")
      end
  ...
  context "parse normal undated pas" do
    ...
    describe "ISO/PAS 23678-3" do
      ...
      it "parses number" do
        expect(parsed.number).to eq("23678")
      end
  ...
  context "parse pas with parts" do
    ...
    describe "ISO/PAS 17208-1:2012" do
      ...
      it "parses number" do
        expect(parsed.number).to eq("17208")
      end
  ...
  context "copublishers" do
    context "copublisher as SAE" do
      ...
      describe "ISO/SAE PAS 22736:2021" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("22736")
        end
  ...
  context "stages" do
    context "preparatory" do
      ...
      describe "ISO/AWI PAS 24499" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("24499")
        end
      ...
      describe "ISO/WD PAS 34507" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("34507")
        end
    ...
    context "committee" do
      ...
      describe "ISO/CD PAS 22399" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("22399")
        end
    ...
    context "enquiry" do
      ...
      describe "ISO/DPAS 45007" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("45007")
        end
      ...
      describe "ISO/DPAS 5474-6" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("5474")
        end
    ...
    context "publication" do
      ...
      describe "ISO/PRF PAS 22596" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("22596")
        end
