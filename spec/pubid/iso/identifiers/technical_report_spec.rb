...
RSpec.describe Pubid::Iso::Identifiers::TechnicalReport do
  ...
  context "parse normal dated technical report" do
    ...
    describe "ISO/TR 10771-2:2008" do
      ...
      it "parses number" do
        expect(parsed.number).to eq("10771")
      end
  ...
  context "parse normal undated technical report" do
    ...
    describe "ISO/TR 10303-307" do
      ...
      it "parses number" do
        expect(parsed.number).to eq("10303")
      end

      it "parses part" do
        expect(parsed.part).to eq("307")
      end
  ...
  context "parse technical report with complex subparts" do
    ...
    describe "ISO/IEC TR 29110-5-1-4" do
      ...
      it "parses subpart" do
        expect(parsed.subpart).to eq("1-4")
      end
  ...
  context "copublishers" do
    context "copublisher as IEC" do
      ...
      describe "ISO/IEC TR 13818-5:2005" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("13818")
        end
    ...
    context "copublisher as ASTM" do
      ...
      describe "ISO/ASTM TR 52906" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("52906")
        end
    ...
    context "copublisher as CIE" do
      ...
      describe "ISO/CIE TR 21783" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("21783")
        end
  ...
  context "aberrations" do
    ...
    describe "ISO/IEC/TR 30148" do
      ...
      it "parses number" do
        expect(parsed.number).to eq("30148")
      end
    ...
    describe "ISO TR 16401-2" do
      ...
      it "parses number" do
        expect(parsed.number).to eq("16401")
      end
    ...
    describe "ISO/TR27809:2007" do
      ...
      it "parses number" do
        expect(parsed.number).to eq("27809")
      end
  ...
  context "stages" do
    context "proposal" do
      ...
      describe "ISO/NP TR 11111" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("11111")
        end
    ...
    context "preparatory" do
      ...
      describe "ISO/WD TR 23642" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("23642")
        end
    ...
    context "committee" do
      ...
      describe "ISO/CD TR 12786.2" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("12786")
        end
    ...
    context "enquiry" do
      ...
      describe "ISO/IEC DTR 27563" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("27563")
        end
      ...
      describe "ISO/ASTM DTR 52905" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("52905")
        end
    ...
    context "approval" do
      ...
      describe "ISO/IEC/IEEE FDTR 17301-1-1:2016(en)" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("17301")
        end
    ...
    context "publication" do
      ...
      describe "ISO/PRF TR 14799-1" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("14799")
        end
      ...
      describe "ISO/PRF TR 23249" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("23249")
        end
      ...
      describe "ISO/PRF TR 31700-2" do
        ...
        it "parses number" do
          expect(parsed.number).to eq("31700")
        end
  ...
  context "stage with iteration" do
    ...
    describe "ISO/CD TR 22260-1.2" do
      ...
      it "parses number" do
        expect(parsed.number).to eq("22260")
      end
  ...
  context "legacy stages" do
    ...
    describe "ISO/IEC PDTR 20943-5" do
      ...
      it "parses number" do
        expect(parsed.number).to eq("20943")
      end
