  ...
  describe ".parse" do
    ...
    context "number and parts" do
      ...
      it "parses with multiple parts" do
        ...
        expect(id.number).to eq("12345")
        expect(id.part).to eq("1")
        expect(id.subpart).to eq("2")
