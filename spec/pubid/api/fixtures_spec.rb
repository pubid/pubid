...
module ApiFixturesSpec
  FIXTURE_FILES = Dir.glob(File.join(__dir__, "../../../fixtures/API/identifiers/pass", "*.txt")).freeze
end

RSpec.describe "API Fixture Round-trip Tests" do

  describe "all fixture files" do
    ApiFixturesSpec::FIXTURE_FILES.each do |fixture_file|
