...
RSpec.describe Pubid::Iec::Identifiers::SystemsReferenceDocument do
  ...
  context "parse normal identifier dated" do
    describe "IEC SRD 62600:2020" do
      ...
      it "parses number" do
        expect(parsed.number).to eq("62600")
      end
  ...
  context "parse normal identifier with part" do
    describe "IEC SRD 63119-1:2021" do
      ...
      it "parses number" do
        expect(parsed.number).to eq("63119")
      end
  ...
  context "parse identifier with part and subpart" do
    describe "IEC SRD 61850-90-12:2022" do
      ...
      it "parses number" do
        expect(parsed.number).to eq("61850")
      end

      it "parses part" do
        expect(parsed.part).to eq("90")
      end

      it "parses subpart" do
        expect(parsed.subpart).to eq("12")
      end
  ...
  context "copublisher as ISO" do
    describe "ISO/IEC SRD 12345:2020" do
      ...
      it "round-trips" do
        expect(parsed.to_s).to eq("ISO/IEC SRD 12345:2020")
      end
  ...
  context "copublisher as IEEE" do
    describe "IEC/IEEE SRD 62582:2022" do
      ...
      it "parses number" do
        expect(parsed.number).to eq("62582")
      end
      ...
      it "round-trips" do
        expect(parsed.to_s).to eq("IEC/IEEE SRD 62582:2022")
      end
    end
  end
  ...
  context "multi-digit number" do
    describe "IEC SRD 123456:2023" do
      ...
      it "parses number correctly" do
        expect(parsed.number).to eq("123456")
      end
