...
RSpec.describe Pubid::Plateau do
  describe ".parse" do
    context "PLATEAU Handbook identifiers" do
      it "parses PLATEAU Handbook #00 第1.0版" do
        ...
        expect(result).to be_a(Pubid::Plateau::Identifiers::Handbook)
    ...
    context "PLATEAU Technical Report identifiers" do
      it "parses PLATEAU Technical Report #01" do
        ...
        expect(result).to be_a(Pubid::Plateau::Identifiers::TechnicalReport)
