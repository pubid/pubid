...
module OimlFixturesSpec
  FIXTURE_FILES = Dir.glob(File.join(__dir__, "../../../fixtures/OIML/identifiers/pass", "*.txt")).freeze
end

RSpec.describe "OIML Fixture Round-trip Tests" do

  describe "all fixture files" do
    OimlFixturesSpec::FIXTURE_FILES.each do |fixture_file|
      describe File.basename(fixture_file) do
        ...
        it "parses and round-trips identifiers" do
          ...
          identifiers.each do |id_str|
            begin
              parsed = PubidNew::Oiml.parse(id_str)
