...
module AmcaFixturesSpec
  FIXTURE_FILES = Dir.glob(File.join(__dir__, "../../../fixtures/AMCA/identifiers/pass", "*.txt")).freeze
end

RSpec.describe "AMCA Fixture Round-trip Tests" do

  describe "all fixture files" do
    AmcaFixturesSpec::FIXTURE_FILES.each do |fixture_file|
