...
module CsaFixturesSpec
  FIXTURE_FILES = Dir.glob(File.join(__dir__, "../../../fixtures/CSA/identifiers/pass", "*.txt")).freeze
end

RSpec.describe "CSA Fixture Round-trip Tests" do

  describe "all fixture files" do
    CsaFixturesSpec::FIXTURE_FILES.each do |fixture_file|
      describe File.basename(fixture_file) do
        ...
        it "parses and round-trips identifiers" do
          ...
          identifiers.each do |id_str|
            begin
              parsed = PubidNew::Csa.parse(id_str)
