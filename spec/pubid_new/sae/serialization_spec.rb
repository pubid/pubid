...
RSpec.describe "SAE Serialization" do
  describe "#to_h" do
    it "exports basic identifier as hash" do
      id = PubidNew::Sae.parse("SAE AMS 1234:2010")
      hash = id.to_h
    ...
    it "exports identifier with AIR type" do
      id = PubidNew::Sae.parse("SAE AIR 5678:2020")
      hash = id.to_h
  ...
  describe "round-trip conversion" do
    it "preserves all data through hash conversion for AMS" do
      original = PubidNew::Sae.parse("SAE AMS 1234:2010")
      hash = original.to_h
    ...
    it "preserves all data through hash conversion for AIR" do
      original = PubidNew::Sae.parse("SAE AIR 5678:2020")
      hash = original.to_h
      restored = PubidNew::Serializable.from_h(hash)
    ...
    it "preserves all data through hash conversion for ARP" do
      original = PubidNew::Sae.parse("SAE ARP 4321:2018")
      hash = original.to_h
      restored = PubidNew::Serializable.from_h(hash)
    ...
    it "preserves all data through JSON conversion" do
      original = PubidNew::Sae.parse("SAE AS 9999:2015")
