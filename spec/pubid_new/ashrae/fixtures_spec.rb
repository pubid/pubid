...
module AshraeFixturesSpec
  FIXTURE_FILES = Dir.glob(File.join(__dir__, "../../../fixtures/ASHRAE/identifiers/pass", "*.txt")).freeze
end

RSpec.describe "ASHRAE Fixture Round-trip Tests" do

  describe "all fixture files" do
    AshraeFixturesSpec::FIXTURE_FILES.each do |fixture_file|
      describe File.basename(fixture_file) do
        ...
        it "parses and round-trips identifiers" do
          ...
          identifiers.each do |id_str|
            begin
              parsed = PubidNew::Ashrae.parse(id_str)
