...
RSpec.describe PubidNew::Identifier do
  describe "#new_edition_of?" do
    ...
    it "raises error for different parts" do
      id1 = PubidNew::Iso.parse("ISO 8601-1:2019")
      id2 = PubidNew::Iso.parse("ISO 8601-2:2019")
    ...
    it "compares documents with parts" do
      id1 = PubidNew::Iso.parse("ISO 8601-1:2019")
      id2 = PubidNew::Iso.parse("ISO 8601-1:2024")
      expect(id2.new_edition_of?(id1)).to be true
    end
  end
end
