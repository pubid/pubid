...
RSpec.describe PubidNew::Iso::Identifiers::Addendum do
  ...
  describe "parsing" do
    it "parses published addendum abbreviation" do
      id = PubidNew::Iso.parse("ISO 9001:2015/Add 1:2020")
      expect(id.class).to eq(PubidNew::Iso::Identifiers::Addendum)
    end
