  ...
  describe ".parse" do
    ...
    context "publisher patterns" do
      ...
      it "parses ISO/SAE copublisher" do
        id = PubidNew::Iso.parse("ISO/SAE PAS 22736:2021")
        expect(id.publisher.body).to eq("ISO")
      ...
      it "parses ISO/ASTM copublisher" do
        id = PubidNew::Iso.parse("ISO/ASTM 51276:2020")
        expect(id.publisher.body).to eq("ISO")
      ...
      it "parses ISO/CIE copublisher" do
        id = PubidNew::Iso.parse("ISO/CIE 11664-1:2019")
        expect(id.publisher.body).to eq("ISO")
    ...
    context "type patterns" do
      ...
      it "parses ISP" do
        id = PubidNew::Iso.parse("ISO/IEC ISP 12062-2:2003")
    ...
    context "typed stage patterns" do
      it "parses FDAM in supplement" do
        ...
        expect(id).to be_a(PubidNew::Iso::Identifiers::Amendment)
        expect(id.typed_stage.stage_code).to eq("fdamd")
        expect(id.to_s).to eq("ISO/IEC 8802-3:2021/FDAM 1")
      end

      it "parses PDAM" do
        id = PubidNew::Iso.parse("ISO 12345:2020/PDAM 2")
        expect(id).to be_a(PubidNew::Iso::Identifiers::Amendment)
      ...
      it "parses DAM" do
        id = PubidNew::Iso.parse("ISO 12345:2020/DAM 1")
        expect(id).to be_a(PubidNew::Iso::Identifiers::Amendment)
      ...
      it "parses FDCOR" do
        id = PubidNew::Iso.parse("ISO 12345:2020/FDCOR 1")
        expect(id).to be_a(PubidNew::Iso::Identifiers::Corrigendum)
        expect(id.typed_stage.stage_code).to eq("fdcor")
        expect(id.to_s).to eq("ISO 12345:2020/FDCOR 1")
      end

      it "parses DCOR" do
        id = PubidNew::Iso.parse("ISO 12345:2020/DCOR 1")
        expect(id).to be_a(PubidNew::Iso::Identifiers::Corrigendum)
      ...
      it "parses DTS" do
        id = PubidNew::Iso.parse("ISO/IEC DTS 25011:2017")
    ...
    context "supplement patterns" do
      ...
      it "parses Suppl" do
        id = PubidNew::Iso.parse("ISO/TR 10000:2000/Suppl 1:2005")
        expect(id).to be_a(PubidNew::Iso::Identifiers::Supplement)
      ...
      it "parses Ext" do
        id = PubidNew::Iso.parse("ISO 1101:1983/Ext 1:1983")
        expect(id).to be_a(PubidNew::Iso::Identifiers::Extract)
        expect(id.type.abbr).to eq("Ext")
        expect(id.to_s).to eq("ISO 1101:1983/Ext 1:1983")
      end

      it "parses AMD (uppercase)" do
        id = PubidNew::Iso.parse("ISO 12345:2020/AMD 1:2021")
        expect(id).to be_a(PubidNew::Iso::Identifiers::Amendment)
        expect(id.to_s).to eq("ISO 12345:2020/AMD 1:2021")
      end

      it "parses COR (uppercase)" do
        id = PubidNew::Iso.parse("ISO 12345:2020/COR 1:2021")
        expect(id).to be_a(PubidNew::Iso::Identifiers::Corrigendum)
      ...
      it "parses multiple supplements" do
        ...
        expect(id.base_identifier).to be_a(PubidNew::Iso::Identifiers::Amendment)
        expect(id.to_s).to eq("ISO/IEC 13818-1:2015/Amd 3:2016/Cor 1:2017")
      end

      it "parses supplement without year" do
        id = PubidNew::Iso.parse("ISO 12345:2020/Amd 1")
        expect(id).to be_a(PubidNew::Iso::Identifiers::Amendment)
        expect(id.number.number).to eq("1")
    ...
    context "DIR SUP pattern" do
      ...
      it "parses directives supplement with IEC copublisher" do
        id = PubidNew::Iso.parse("ISO/IEC DIR 2 ISO/IEC SUP:2023")
        expect(id.type.abbr).to eq("DIR SUP")
    ...
    context "number and parts" do
      ...
      it "parses with multiple parts" do
        id = PubidNew::Iso.parse("ISO 12345-1-2:2020")
      ...
      it "parses alphanumeric part" do
        id = PubidNew::Iso.parse("ISO 12345-A01:2020")
        expect(id.number.number).to eq("12345")
    ...
    context "years and languages" do
      ...
      it "parses single language" do
        id = PubidNew::Iso.parse("ISO 19115:2003(E)")
      ...
      it "parses multiple languages with comma" do
        id = PubidNew::Iso.parse("ISO 19115:2003(E,F)")
    ...
    context "complex combinations" do
      it "parses identifier with all features" do
        id = PubidNew::Iso.parse("ISO/IEC TR 29186-1:2012(E/F)")
      ...
      it "parses three-level supplement" do
        id = PubidNew::Iso.parse("ISO 12345:2020/Amd 1:2021/Cor 1:2022/Amd 2:2023")
        expect(id).to be_a(PubidNew::Iso::Identifiers::Amendment)
