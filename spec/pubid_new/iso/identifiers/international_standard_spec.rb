...
RSpec.describe PubidNew::Iso::Identifiers::InternationalStandard do
  ...
  context "parse identifiers with edition" do
    ...
    describe "ISO 22610:2006 Ed" do
      ...
      it "parses edition" do
        expect(parsed.edition.number).to be_nil
      end
      ...
      xit "generates urn to pubid" do
        expect(described_class.parse_urn(urn).to_s(with_edition: true)).to eq(pubid_with_edition)
      end
    end
  ...
  context "parse normal identifier with subpart" do
    ...
    describe "ISO 80601-2-61:2019" do
      ...
      let(:undated) { described_class.parse("ISO 80601-2-61") }
      ...
      xit "generates urn to undated pubid" do
        expect(described_class.parse_urn(urn).to_s).to eq(undated.to_s)
      end
    end
  ...
  context "parse normal identifier with sub-subpart" do
    ...
    describe "ISO/IEC 29110-5-1-1:2025" do
      ...
      let(:undated) { described_class.parse("ISO/IEC 29110-5-1-1") }
  ...
  context "copublishers" do
    ...
    context "abberations" do
      ...
      describe "ISO /IEC 17030:2003" do
        ...
        let(:undated) { described_class.parse("ISO/IEC 17030") }
      ...
      context "parses Unicode hyphen" do
        ...
        describe "U+2010" do
          ...
          it "round-trips" do
            expect(described_class.parse(subject).to_s).to eq(pubid)
          end
        end
    ...
    context "copublisher as IEC" do
      ...
      describe "ISO/IEC 10164-22:2000" do
        ...
        let(:undated) { described_class.parse("ISO/IEC 10164-22") }
    ...
    context "copublisher as IEEE" do
      describe "ISO/IEEE 11073-20601:2010" do
        ...
        let(:parsed) { described_class.parse(subject) }
        let(:undated) { described_class.parse("ISO/IEEE 11073-20601") }
    ...
    context "copublisher as IEC/IEEE" do
      ...
      describe "ISO/IEC/IEEE 26512" do
        ...
        let(:parsed) { described_class.parse(subject) }
        let(:undated) { described_class.parse("ISO/IEC/IEEE 26512") }
    ...
    context "copublisher as CIE" do
      ...
      describe "ISO/CIE 11664-1:2019" do
        ...
        let(:undated) { described_class.parse("ISO/CIE 11664-1") }
        ...
        it "parses copublisher" do
          expect(parsed.copublishers.first.body).to eq("CIE")
        end
    ...
    context "copublisher as HL7" do
      describe "ISO/HL7 27953-2:2011" do
        ...
        let(:undated) { described_class.parse("ISO/HL7 27953-2") }
        ...
        it "parses copublisher" do
          expect(parsed.copublishers.first.body).to eq("HL7")
        end
    ...
    context "copublisher as SAE" do
      ...
      describe "ISO/SAE 21434:2021" do
        ...
        let(:undated) { described_class.parse("ISO/SAE 21434") }
    ...
    context "copublisher as OECD" do
      ...
      describe "ISO/OECD 789-10:2006" do
        ...
        let(:undated) { described_class.parse("ISO/OECD 789-10") }
        ...
        it "parses copublisher" do
          expect(parsed.copublishers.first.body).to eq("OECD")
        end
    ...
    context "copublisher as ASTM" do
      ...
      describe "ISO/ASTM 52901:2017" do
        ...
        let(:undated) { described_class.parse("ISO/ASTM 52901") }
    ...
    context "copublisher as UNDP" do
      ...
      describe "ISO/UNDP 53001:2025" do
        ...
        let(:undated) { described_class.parse("ISO/UNDP 53001") }
        ...
        it "parses copublisher" do
          expect(parsed.copublishers.first.body).to eq("UNDP")
        end
  ...
  context "stages" do
    ...
    context "stage without iteration" do
      context "preliminary" do
        ...
        describe "ISO/PWI 19171" do
          ...
          xit "generates urn to pubid" do
            expect(described_class.parse_urn(urn).to_s).to eq(subject)
          end
        end
      ...
      context "proposal" do
        ...
        describe "ISO/NWIP 19144-4" do
          ...
          xit "generates urn" do
            expect(described_class.parse(subject).to_urn).to eq(urn)
          end

          xit "generates urn to pubid" do
            expect(described_class.parse_urn(urn).to_s).to eq(pubid)
          end
        end
      end
      ...
      context "enqiury" do
        ...
        describe "ISO/UNDP DIS 53001" do
          ...
          it "parses stage" do
            expect(parsed.stage.stage_code).to eq("dis")
          end
    ...
    context "stage with iteration" do
      ...
      describe "ISO/CD2 14065:2018" do
        ...
        let(:undated) { described_class.parse("ISO/CD 14065.2") }
    ...
    context "legacy stages" do
      ...
      describe "ISO/IEC FCD 42010" do
        ...
        it "parses stage" do
          expect(parsed.stage.stage_code).to eq("fcd")
        end
        ...
        xit "generates urn to pubid" do
          expect(described_class.parse_urn(urn).to_s).to eq(described_class.parse(urn_pubid).to_s)
        end
      end
      ...
      describe "ISO/IEC preCD 29135" do
        ...
        it "parses stage" do
          expect(parsed.stage.stage_code).to eq("pcd")
        end
  ...
  xcontext "urn parsing" do
    context "stage-draft as 40.00" do
      ...
      describe "ISO/IEC FDIS 7816-6" do
        ...
        let(:parsed) { described_class.parse_urn(subject) }
