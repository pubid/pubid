...
RSpec.describe PubidNew::Iso::Identifiers::Guide do
  ...
  xdescribe "parse identifiers from examples" do
    ...
    context "parses identifiers from iso-guide.txt" do
      let(:examples_file) { "iso/iso-guide.txt" }
  ...
  context "stages" do
    ...
    context "enquiry" do
      describe "ISO/DGUIDE 84:2024(en)" do
        ...
        it "parses stage" do
          expect(parsed.stage.stage_code).to eq("dguide")
        end
      ...
      describe "ISO/DGUIDE 83:2023(E)" do
        ...
        let(:parsed) { described_class.parse(subject) }
        let(:normalized) { "ISO/DGuide 83:2023(en)" }
    ...
    context "approval" do
      describe "ISO/IEC FDGuide 98-6:2020(E)" do
        ...
        let(:parsed) { described_class.parse(subject) }
        let(:normalized) { "ISO/IEC FDGuide 98-6:2020(en)" }
        ...
        it "parses stage" do
          expect(parsed.stage.stage_code).to eq("fdguide")
        end
  ...
  context "languages" do
    describe "ISO/IEC Guide 2:2004(E/F/R)" do
      ...
      let(:parsed) { described_class.parse(subject) }
      let(:normalized) { "ISO/IEC Guide 2:2004(en,fr,ru)" }
