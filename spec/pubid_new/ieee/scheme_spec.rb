...
RSpec.describe PubidNew::Ieee::Scheme do
  describe ".typed_stages" do
    it "returns array of TYPED_STAGES" do
      ...
      expect(stages).to all(be_a(PubidNew::Ieee::Components::TypedStage))
    end
  ...
  describe ".default_typed_stage" do
    it "returns the default typed stage" do
      ...
      expect(default).to be_a(PubidNew::Ieee::Components::TypedStage)
    end
  end
  ...
  describe ".locate_typed_stage_by_abbr" do
    ...
    it "returns typed stage for known abbreviation" do
      ...
      expect(stage).to be_a(PubidNew::Ieee::Components::TypedStage)
    end
  ...
  describe ".locate_identifier_klass_by_type_code" do
    it "returns ProjectDraftIdentifier class for draft type code" do
      ...
      expect(klass).to eq(PubidNew::Ieee::Identifiers::ProjectDraftIdentifier)
    end
