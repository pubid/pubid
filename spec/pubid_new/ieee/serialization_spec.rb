...
RSpec.describe "IEEE Serialization" do
  describe "#to_h" do
    it "exports basic identifier as hash" do
      id = PubidNew::Ieee.parse("IEEE Std 1277-2000")
      hash = id.to_h
    ...
    it "exports identifier with copublisher as combined publisher string" do
      id = PubidNew::Ieee.parse("ANSI/IEEE Std 101-1987")
      hash = id.to_h
    ...
    it "exports identifier with draft" do
      id = PubidNew::Ieee.parse("IEEE P1647")
      hash = id.to_h
  ...
  describe "round-trip conversion" do
    it "preserves all data through hash conversion" do
      original = PubidNew::Ieee.parse("IEEE Std 1277-2000")
      hash = original.to_h
