...
module AstmFixturesSpec
  FIXTURE_FILES = Dir.glob(File.join(__dir__, "../../../fixtures/ASTM/identifiers/pass", "*.txt")).freeze
end

RSpec.describe "ASTM Fixture Round-trip Tests" do

  describe "all fixture files" do
    AstmFixturesSpec::FIXTURE_FILES.each do |fixture_file|
      describe File.basename(fixture_file) do
        ...
        it "parses and round-trips identifiers" do
          ...
          identifiers.each do |id_str|
            begin
              parsed = PubidNew::Astm.parse(id_str)
