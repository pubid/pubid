...
RSpec.describe PubidNew::Astm::Identifiers::IsoDualPublished do
  ...
  describe "ISO/ASTM dual-published standards (5xxxx series)" do
    ...
    context "parses normal identifier" do
    ...
    context "parses reapproval identifier" do
    ...
    context "parses identifier with edition" do
    ...
    context "parses identifier without edition" do
    ...
    describe "ISO counterpart relationship" do
      it "ASTM 52303-24e1 corresponds to ISO/ASTM 52303:2024" do
        ...
        expect(iso_version.code.number).to eq("52303")
        expect(iso_version.year).to eq("2024")
        expect(iso_version.copublishers.first.body).to eq("ASTM")
