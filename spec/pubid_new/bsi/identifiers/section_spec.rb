...
RSpec.describe PubidNew::Bsi::Identifiers::Section do
  describe "parsing" do
    it "parses DD 51:Section 0:1977" do
      id = PubidNew::Bsi.parse("DD 51:Section 0:1977")
      expect(id.class).to eq(PubidNew::Bsi::Identifiers::Section)
    end

    it "parses DD 51:Section 1:1977" do
      id = PubidNew::Bsi.parse("DD 51:Section 1:1977")
      expect(id.class).to eq(PubidNew::Bsi::Identifiers::Section)
    end

    it "parses BS 3224 Section B2:1970" do
      id = PubidNew::Bsi.parse("BS 3224 Section B2:1970")
      expect(id.class).to eq(PubidNew::Bsi::Identifiers::Section)
    end

    it "parses BS 3224 Section C1:1963" do
      id = PubidNew::Bsi.parse("BS 3224 Section C1:1963")
      expect(id.class).to eq(PubidNew::Bsi::Identifiers::Section)
    end
  end
  ...
  describe "attributes" do
    it "extracts section_id correctly" do
      id = PubidNew::Bsi.parse("DD 51:Section 7:1977")
