...
module BsiFixturesSpec
  FIXTURE_FILES = Dir.glob(File.join(__dir__, "../../../fixtures/bsi/identifiers/pass", "*.txt")).freeze
end

RSpec.describe "BSI Fixture Round-trip Tests" do

  describe "all fixture files" do
    BsiFixturesSpec::FIXTURE_FILES.each do |fixture_file|
      describe File.basename(fixture_file) do
        ...
        it "parses and round-trips identifiers" do
          ...
          identifiers.each do |id_str|
            begin
              parsed = PubidNew::Bsi.parse(id_str)
