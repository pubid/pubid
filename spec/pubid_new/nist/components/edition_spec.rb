...
RSpec.describe PubidNew::Nist::Components::Edition do
  ...
  describe "integration with parsing" do
    context "parsing identifiers with edition" do
      # NOTE: These two simple patterns require parser enhancement
      # Parser currently doesn't recognize standalone "e2" or "r5" patterns
      xit "parses e2 pattern" do
