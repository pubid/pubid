...
module CieFixturesSpec
  FIXTURE_FILES = Dir.glob(File.join(__dir__, "../../../fixtures/CIE/identifiers/pass", "*.txt")).freeze
end

RSpec.describe "CIE Fixture Round-trip Tests" do

  describe "all fixture files" do
    CieFixturesSpec::FIXTURE_FILES.each do |fixture_file|
      describe File.basename(fixture_file) do
        ...
        it "parses and round-trips identifiers" do
          ...
          identifiers.each do |id_str|
            begin
              parsed = PubidNew::Cie.parse(id_str)
