...
module IdfFixturesSpec
  FIXTURE_FILES = Dir.glob(File.join(__dir__, "../../../fixtures/IDF/identifiers/pass", "*.txt")).freeze
end

RSpec.describe "IDF Fixture Round-trip Tests" do

  describe "all fixture files" do
    IdfFixturesSpec::FIXTURE_FILES.each do |fixture_file|
      describe File.basename(fixture_file) do
        ...
        it "parses and round-trips identifiers" do
          ...
          identifiers.each do |id_str|
            begin
              parsed = PubidNew::Idf.parse(id_str)
