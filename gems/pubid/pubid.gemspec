...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "pubid-bsi", "= 1.15.13"
  spec.add_dependency "pubid-ccsds", "= 1.15.13"
  spec.add_dependency "pubid-cen", "= 1.15.13"
  spec.add_dependency "pubid-core", "= 1.15.13"
  ...
  spec.add_dependency "pubid-nist", "= 1.15.13"
  spec.add_dependency "pubid-plateau", "= 1.15.13"
end
