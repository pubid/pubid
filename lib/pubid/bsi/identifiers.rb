...
module Pubid
  module Bsi
    module Identifiers
      ...
      autoload :AdoptedInternationalStandard, "#{__dir__}/identifiers/adopted_international_standard"
      ...
      autoload :BritishIndustrialPractice, "#{__dir__}/identifiers/british_industrial_practice"
      ...
      autoload :DetailedSpecification, "#{__dir__}/identifiers/detailed_specification"
      ...
      autoload :ExplanatorySupplement, "#{__dir__}/identifiers/explanatory_supplement"
      ...
      autoload :StandaloneAmendment, "#{__dir__}/identifiers/standalone_amendment"
      ...
      autoload :ValueAddedPublication, "#{__dir__}/identifiers/value_added_publication"
    end
  end
end