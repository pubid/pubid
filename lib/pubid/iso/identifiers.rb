...
module Pubid
  module Iso
    module Identifiers
      ...
      autoload :DirectivesSupplement, "#{__dir__}/identifiers/directives_supplement"
      ...
      autoload :InternationalStandardizedProfile, "#{__dir__}/identifiers/international_standardized_profile"
      autoload :InternationalWorkshopAgreement, "#{__dir__}/identifiers/international_workshop_agreement"
      ...
      autoload :TechnologyTrendsAssessments, "#{__dir__}/identifiers/technology_trends_assessments"
    end
  end
end
