...
module Pubid
  module Nist
    module Identifiers
      ...
      autoload :CommercialStandardEmergency, "#{__dir__}/identifiers/commercial_standard_emergency"
      autoload :CommercialStandardsMonthly, "#{__dir__}/identifiers/commercial_standards_monthly"
      autoload :CrplReport, "#{__dir__}/identifiers/crpl_report"
      autoload :FederalInformationProcessingStandards, "#{__dir__}/identifiers/federal_information_processing_standards"
      autoload :GrantContractorReport, "#{__dir__}/identifiers/grant_contractor_report"
      ...
      autoload :MiscellaneousPublication, "#{__dir__}/identifiers/miscellaneous_publication"
