...
module Pubid
  module CenCenelec
    module Identifiers
      ...
      autoload :CENelecHarmonizationDocument,
               "#{__dir__}/identifiers/cenelec_harmonization_document"
      autoload :CenReport, "#{__dir__}/identifiers/cen_report"
      autoload :CenWorkshopAgreement,
               "#{__dir__}/identifiers/cen_workshop_agreement"
      ...
      autoload :EuropeanPrestandard,
               "#{__dir__}/identifiers/european_prestandard"
      autoload :EuropeanSpecification,
               "#{__dir__}/identifiers/european_specification"
      autoload :Fragment, "#{__dir__}/identifiers/fragment"
      autoload :Guide, "#{__dir__}/identifiers/guide"
      autoload :HarmonizationDocument,
               "#{__dir__}/identifiers/harmonization_document"
