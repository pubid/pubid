  ...
  module Astm
    module Identifiers
      ...
      class IsoDualPublished < Standard
        ...
        # @return [PubidNew::Iso::Identifiers::InternationalStandard] ISO version
        #
        # @example Convert ASTM to ISO format
        #   astm = PubidNew::Astm.parse("ASTM 52303-24e1")
        ...
        def to_iso_identifier
          ...
          if year
            iso_date = ::PubidNew::Components::Date.new
