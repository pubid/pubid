...
module PubidNew
  module Utils
    ...
    # == Usage
    #
    #   PubidNew::Utils::StringNormalizer.normalize_dashes(str)
    #   PubidNew::Utils::StringNormalizer.normalize_whitespace(str)
    #   PubidNew::Utils::StringNormalizer.split_compound_number(str)
    #
