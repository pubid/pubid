  ...
  module Iso
    module Identifiers
      ...
      class TcDocument < Base
        ...
        attribute :tc_type, ::PubidNew::Components::Code
        # TC number
        attribute :tc_number, ::PubidNew::Components::Code
        # SC type
        attribute :sc_type, ::PubidNew::Components::Code
        # SC number
        attribute :sc_number, ::PubidNew::Components::Code
        # WG type
        attribute :wg_type, ::PubidNew::Components::Code
        # WG number
        attribute :wg_number, ::PubidNew::Components::Code
