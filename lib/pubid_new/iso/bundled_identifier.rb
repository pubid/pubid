...
module PubidNew
  module Iso
    ...
    class BundledIdentifier < Identifier
      ...
      attribute :supplements, ::PubidNew::Identifier, polymorphic: true, collection: true
      ...
      def to_s(lang: :en, lang_single: false, with_edition: false, format: nil, stage_format_long: nil, with_date: nil)
        parts = [base_document.to_s(lang: lang, lang_single: lang_single, with_edition: with_edition, format: format, stage_format_long: stage_format_long, with_date: with_date)]
        ...
        supplements.each do |supplement|
          ...
          supplement_str = if supplement.respond_to?(:to_supplement_s)
            supplement.to_supplement_s(lang: lang, lang_single: lang_single, with_edition: with_edition, format: format, stage_format_long: stage_format_long, with_date: with_date)
          else
            supplement.to_s(lang: lang, lang_single: lang_single, with_edition: with_edition, format: format, stage_format_long: stage_format_long, with_date: with_date)
          end
