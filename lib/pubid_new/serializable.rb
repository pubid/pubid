...
module PubidNew
  ...
  #   PubidNew::Serializable.from_h(hash) # => #<PubidNew::Iso::Identifiers::InternationalStandard>
  #
  # @example Import from JSON
  #   json = '{"flavor":"iso","publisher":"ISO","number":"9001","year":"2015"}'
  #   PubidNew::Serializable.from_json(json) # => #<PubidNew::Iso::Identifiers::InternationalStandard>
  #
  module Serializable
    ...
    def self.from_mr_string(mr_string)
      ...
      flavor_module = PubidNew.const_get(flavor.capitalize)
    ...
    def extract_flavor
      # Get class name and extract flavor (e.g., "PubidNew::Iso::Identifiers::InternationalStandard" -> "iso")
